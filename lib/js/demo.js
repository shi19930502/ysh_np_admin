// 初始化插件
var BASE_BASE_SZIP, BASE_SZPORT, BASE_SZUSERNAME, BASE_SZPASSWORD, BASE_CHANNELID;
var BASE_BASE_SZIP_IP1 = '112.238.60.198', BASE_BASE_SZIP_IP2 = '221.0.110.75'
...
var		base_base_szIP = "124.131.43.117",
		base_szPort = "7061",
		base_szUsername = "admin",
		base_szPassword = "12345678a";
		base_channelId = 2;

// 登录
function clickLogin() {
	var szIP = BASE_BASE_SZIP,
		szPort = BASE_SZPORT,
		szUsername = BASE_SZUSERNAME,
		szPassword = BASE_SZPASSWORD;
